...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const defaultWishes = [
    { name: "Bapak Robert", text: "Selamat kagem temanten kekalih, sugeng ambal warsa ing katresnan. Mugi-mugi tansah pinaringan berkah lan kabagyan." },
    { name: "Siti Komala Sari", text: "Selamat Kevin lan Eka! Semoga menjadi keluarga yang sakinah, mawaddah, warahmah. Aamiin YRA." }
  ];
